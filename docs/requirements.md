...
| --- | --- | --- | --- |
| REQ-01 one identity | [zitadel LOCAL-001](modules/openid-connect-zitadel/adr/LOCAL-001-oidc-provider-zitadel.md), [ADR 007](adr/007-modules-receive-credentials.md), [ADR 011](adr/011-environments-are-clusters.md) | [openid-connect-zitadel](modules/openid-connect-zitadel/README.md) | OIDC-01, OIDC-02, OIDC-03 |
| REQ-02 independent signals | [observability LOCAL-001](modules/observability-victoria-metrics/adr/LOCAL-001-victoriametrics-family.md) | [observability-victoria-metrics](modules/observability-victoria-metrics/README.md) | OBS-01, OBS-02, OBS-03 |
| REQ-03 one query surface | [observability LOCAL-002](modules/observability-victoria-metrics/adr/LOCAL-002-alerting-in-grafana.md) | [observability-victoria-metrics](modules/observability-victoria-metrics/README.md) | OBS-04 |
...
| REQ-06 closed by default | [ADR 007](adr/007-modules-receive-credentials.md) | [platform](platform.md) | PLAT-03, PLAT-04, OBS-05, SEC-03, AUD-04 |
...
| REQ-09 swappable implementations | [ADR 004](adr/004-scrape-config-via-prometheus-crds.md), [ADR 007](adr/007-modules-receive-credentials.md), [zitadel LOCAL-001](modules/openid-connect-zitadel/adr/LOCAL-001-oidc-provider-zitadel.md) | [platform](platform.md) | OIDC-01, OBS-06 |
| REQ-10 fits a tiny cluster | [zitadel LOCAL-001](modules/openid-connect-zitadel/adr/LOCAL-001-oidc-provider-zitadel.md), [observability LOCAL-001](modules/observability-victoria-metrics/adr/LOCAL-001-victoriametrics-family.md), [observability LOCAL-002](modules/observability-victoria-metrics/adr/LOCAL-002-alerting-in-grafana.md), [ADR 011](adr/011-environments-are-clusters.md) | [platform](platform.md) | OIDC-04 |
